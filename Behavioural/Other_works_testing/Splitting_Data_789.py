...
def Drowsy_training(a, valid=True, seeding=True):
    ...
    if (a == 1 or  a == 2 or a == 6 or a == 8):
        case = 1
    elif (a == 3):
        case = 2
    elif (a == 4 or a == 5 or a == 11 or a ==  14):
        case = 3
    elif (a == 7 or a == 9 or a == 10):
        case = 4
    elif (a == 12):
        case = 5
    elif (a == 13):
...
def get_train_test_Physiological(awake_subs, drowsy_subs, data, valid_trials_awake, valid_trials_drowsy, time, base):
    ...
    if EEG:
        ...
        awake = np.array([1.1, 1.2, 10.1, 11.1, 12.1, 13.1, 13.2, 14.1, 2.1, 2.3, 3.1, 3.2, 3.3, 4.1, 5.1, 6.2,
                          7.2, 8.1, 8.2, 9.2])
...
def get_train_test_Behavioural(awake_subs, drowsy_subs, data, label, valid, subs_array):
